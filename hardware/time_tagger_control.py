...
class TimeTaggerControl( HasTraits ):
    ...
    traits_view = View( VGroup(Label('Channel'), Label('Trigger level [V]'), Label('count rate [1/s]'),
                             ...
                             Label('1'), Item('trigger_level_1'), Item('count_rate_1', style='readonly', format_str='%.f', width=-80),
                             Label('2'), Item('trigger_level_2'), Item('count_rate_2', style='readonly', format_str='%.f', width=-80),
                             Label('3'), Item('trigger_level_3'), Item('count_rate_3', style='readonly', format_str='%.f', width=-80),
                             Label('4'), Item('trigger_level_4'), Item('count_rate_4', style='readonly', format_str='%.f', width=-80),
                             Label('5'), Item('trigger_level_5'), Item('count_rate_5', style='readonly', format_str='%.f', width=-80),
                             Label('6'), Item('trigger_level_6'), Item('count_rate_6', style='readonly', format_str='%.f', width=-80),
                             Label('7'), Item('trigger_level_7'), Item('count_rate_7', style='readonly', format_str='%.f', width=-80),
